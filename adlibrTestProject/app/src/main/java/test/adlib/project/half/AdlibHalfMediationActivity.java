package test.adlib.project.half;
...
public class AdlibHalfMediationActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_adlib_half_mediation);
                ...
                try {
                    switch (message.what) {
                        ...
                        case AdlibManager.BANNER_FAILED:
                            ...
                            Toast.makeText(AdlibHalfMediationActivity.this, "광고수신 실패 :)", Toast.LENGTH_SHORT).show();
                            break;
                    }
                } catch (Exception e) {
